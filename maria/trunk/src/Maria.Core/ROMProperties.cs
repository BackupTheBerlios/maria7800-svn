...
// TODO : we'll rework this later, into a system that allows
// system/user properties, but first we should get the emu up
// and running at all...
namespace Maria.Core {
	public class ROMProperties
	{
		...
		// TODO : disabled to get things to compile a bit quicker...
		/*public void Dump()
		{
			if (PropertyTable == null)
			{
